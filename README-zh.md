...
```
1. 下载  →  从 Releases 下载 SD-Trainer-v2.5.1.7z（约 380 MB，含离线打标模型与 git 元数据），解压
...
| 日期 | 版本 |
|------|------|
| 2026-05-24 | **v2.5.1** — 整合包保留 `.git` 与离线打标模型（约 380 MB）；配置导入防呆与多层 Anima 类型识别；JSON 历史参数修复；Anima 旧配置路由与打标进度修复 |
