...
class ExtensionLayout:
    ...
    def package_dir(self) -> Path:
        return self.source / "toolkit"

    @property
    def train_script(self) -> Path:
        return self.source / "run.py"
...
def default_layout(root: Path | None = None) -> ExtensionLayout:
    ...
    return ExtensionLayout(base / "extensions" / "ai_toolkit")
...
def _missing_runtime_files(layout: ExtensionLayout) -> list[str]:
    required = (
        (layout.train_script, "run.py"),
        (layout.package_dir, "toolkit"),
        (layout.source / "extensions_built_in", "extensions_built_in"),
        (layout.source / "requirements_base.txt", "requirements_base.txt"),
    )
