...
UI_ONLY_FIELDS = {
    ...
    "additional_preview_prompts",
    "sample_conditioning_image",
    "sample_conditioning_reference_dir",
    "random_conditioning_preview_image",
    "sample_conditioning_image_data_dir",
