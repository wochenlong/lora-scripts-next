# Ported from muooon/EmoSens (Apache License 2.0)
# https://github.com/muooon/EmoSens/blob/v3.9.0_ecc/scheduler/emopulse_scheduler.py
# Copyright (c) muooon. Used under Apache License 2.0.
import math
import torch
